        ...
        <div className="mb-16">
          ...
          <div className="bg-white/80 rounded-2xl shadow-lg p-8 md:p-12 mb-8 border border-[#80deac]/30">
            ...
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
              ...
              <br /><br />
              Nosso primeiro grande projeto foi o <span className="font-bold text-[#f27d13]">Unifoco endemias</span>, que nasceu do propósito de unir tecnologia e saúde para preservar vidas, mostrando desde o início nossa vocação em usar a tecnologia como ferramenta de impacto social.
            </p>
          </div>
